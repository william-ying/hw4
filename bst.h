...
{
    Node<Key, Value>* temp1 = BinarySearchTree<Key, Value>::getSmallestNode(this->current_);
    Node<Key, Value>* temp2 = BinarySearchTree<Key, Value>::getSmallestNode(rhs->current_);
